...
export function FirstModalShell({ children }) {
  const { stack, top, topIndex, requestCloseTopViaHistory, registerPanelRef } =
    useModal();

  if (!top || top.modalId !== MODALS.FIRST) return null;
  ...
  return (
    <div
      data-modal={MODALS.FIRST}
      data-modal-instance={instanceKey}
      className="fixed inset-0 top-[10%] left-[10%] z-[100]"
    >
      {/* Backdrop */}
      <div
