...
export function ThirdModalShell({ children }) {
  const { stack, top, topIndex, requestCloseTopViaHistory, registerPanelRef } =
    useModal();

  if (!top || top.modalId !== MODALS.THIRD) return null;
  ...
  return (
    <div
      data-modal={MODALS.THIRD}
      data-modal-instance={instanceKey}
      className="fixed inset-0 top-[30%] left-[30%] z-[100]"
    >
      {/* Backdrop */}
      <div
